...
exports.User = db.sequelize.define('user', {
    firstName: {
      type: Sequelize.STRING,
      allowNull: false,
      get: () -> this.getDataValue('firstname'),
      set: (firstName) -> this.setDataValue('firstName', firstName),
      validate: {
        len: [4,24],
        is: ["[a-zA-Z ]", "i"]
      }
    ...
    lastName: {
      type: Sequelize.STRING,
      allowNull: false,
      get: () -> this.getDataValue('lastname'),
      set: (lastName) -> this.setDataValue('lastName', lastName),
      validate: {
        len: [4,24],
        is: ["[a-zA-Z ]", "i"]
      }
    ...
    username: {
      type: Sequelize.STRING,
      allowNull: false,
      get: () -> this.getDataValue('username'),
      set: (username) -> this.setDataValue('username', username),
      validate: {
        len: [4,16],
        is: ["[a-zA-Z_]", "i"]
      }
