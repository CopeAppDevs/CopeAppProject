var ClassSchema, RoleSchema, SchoolSchema, SettingsSchema, StudentSchema, TeacherSchema, db, mongoose;
...
ClassSchema = new mongoose.Schema({
  section: {
    type: String,
    required: [true, "Section for class is required"]
  },
  grade: {
    type: String,
    required: [true, "Grade for class is required"]
  },
  subject: {
    type: String,
    required: [true, "Subject for class is required"]
  },
  location: {
    type: String,
...
RoleSchema = new mongoose.Schema({
  ...
  description: {
    type: String,
    required: [true, "Description for role is required"]
  }
});
...
StudentSchema = new mongoose.Schema({
  firstName: {
    type: String,
    required: [true, "FirstName for student is required"]
  },
  lastName: {
    type: String,
    required: [true, "LastName for student is required"]
  },
  username: {
    type: String,
    required: [true, "Username for student is required"]
  },
  password: {
    type: String,
    required: [true, "Password for student is required"]
  },
  email: {
    type: String,
    required: [true, "Email for student is required"]
  },
  roles: [
    {
      type: mongoose.Schema.Types.ObjectId,
...
TeacherSchema = new mongoose.Schema({
  firstName: {
    type: String,
    required: [true, "FirstName for teacher is required"]
  },
  lastName: {
    type: String,
    required: [true, "LastName for teacher is required"]
  },
  username: {
    type: String,
    required: [true, "Username for teacher is required"]
  },
  password: {
    type: String,
    required: [true, "Password for teacher is required"]
  },
  email: {
    type: String,
    required: true
